...
The HTTP client layer between the MCP tools and the Pocket ID API: authentication, error mapping, multipart uploads, binary downloads, and coverage accounting against the vendored OpenAPI spec.
