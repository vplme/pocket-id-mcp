...
The MCP server runtime: transport selection, OAuth 2.1 protection in HTTP mode, configuration, startup validation, safety-tier tool registration, workflow prompts, and structured output schemas.
